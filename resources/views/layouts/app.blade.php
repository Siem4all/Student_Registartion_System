...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="d-flex align-items-center bg-info text-white">
    <div class="container d-flex align-items-center justify-content-between">

      <h1 class="logo text-white"><a href="" class="site_title"><img src="images/target.png" width="100" heigth="700"> <span>Target Film Academy</span></a></h1>
