              ...
              <div class="card-deck">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header">
                    <strong class="card-title text-success">New Bank Account</strong>
                  </div>
                  <div class="card-body">
              ...
              <form method="post" action="{{ route('account.store') }}">
                       @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                            <select id="country" class="form-control col-md-12"  name="sid" required>
             ...
             @foreach($banks as $bank)
                ...
                @endforeach
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="number" class="form-control @error('acc') is-invalid @enderror" name="acc" value="{{ old('acc') }}" required autocomplete="mname" autofocus>
