...
<div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All Payments</h2><a class="offset-md-9 btn bg-success text-white" href="payment/create">Delete Old UnPaid</a>
  ...
  <td class="form-check-inline"><a  class="btn btn-md bg-warning" href="{{ route('payment.edit', $payment->id) }}">Paid</a>
  </td>
    </tr>
    @endforeach
  </tbody>
