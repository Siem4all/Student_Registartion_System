              ...
              <div class="col-10">
                ...
                @csrf
                          <div class="row mb-3">
                              ...
                              <div class="col-md-8">
                                  <input id="subject" type="text" class="form-control @error('subject') is-invalid @enderror" name="subject" value="{{$notice->subject }}" required autocomplete="subject" autofocus>
