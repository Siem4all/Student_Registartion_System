...
class ScheduleController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $schedule->save();
        return redirect('/schedule')->with('success', 'Created successfuly');
    }
    ...
    public function show($id)
    {
        ...
        $teachers=User::where('user_role','LIKE',3)->get();
        return view('admin.schedule.create',compact('sections','teachers'));
    ...
    public function edit($id)
    {
        ...
        return view('admin.schedule.edit',compact('schedule','sections','teachers'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       $schedule->save();
        return redirect('/schedule')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy($id)
    {
        ...
        $schedule=Schedule::find($id); 
        $schedule->delete();
        return redirect('/schedule')->with('success', 'Deleted successfuly');
