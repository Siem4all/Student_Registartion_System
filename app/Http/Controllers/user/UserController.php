...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        public function formOne($id)  
       {
            ...
            return view('user.user.form1',compact('user','colleges'));
        }
        public function formTwo($id){
            ...
            return view('user.user.form2',compact('user','languages','arts','participations','specials','professions'));
        }
    ...
    public function store(Request $request)
    {
       ...
       $user->save();
        return redirect('/user_access/form1/'.$code)->with('success', 'Created successfuly');
    ...
    public function edit($id)
    {
        ...
        $user->skin_color==null and $user->religion	==null and $user->old_address==null and $user->new_address==null){
            return redirect('/user_access/form1/'.$code)->with('error', 'Please fill the form');
        }
        elseif($user->num==1){
            return redirect('user_access/form2/'.$id)->with('error', 'Please fill the form');
        }
        else{
            $languages=Language::all();
            $arts=AbilityInArt::all();
            ...
            $specials=SpecialAbility::all();
            $colleges=College::all();
            return view('user.user.edit',compact('colleges','user','languages','arts','participations','specials','professions'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($num==1){
            ...
            $user->save();
            return redirect('user_access/create');
        }
        elseif($num==2){
            ...
            $user->num=1;
            $user->save();
            return redirect('user_access/form2/'.$id);
        }
        elseif($num==3){
        $user=User::find($id);
